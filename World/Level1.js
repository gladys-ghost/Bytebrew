...
export default class Level1 {
    constructor(scene, camera) {  // Pass the camera as well to modify clipping planes
        this.scene = scene;
        ...
        this.wall3 = new Wall(0, 0, -25 , Math.PI / 2, 50);
        ...
        this.bedroomWall2 = new Wall(-16.5 + this.offset - slightOffset, 0, 15 + this.offset - slightOffset, Math.PI / 2, 13);
        ...
        this.enemyRoomWall2 = new Wall(10 - this.offset + slightOffset, 0, 15 - this.offset - slightOffset, Math.PI / 2, 13);
        this.enemyRoomGroup.add(this.enemyRoomWall2.mesh);    
        
        this.enemyRoomWall4 = new Wall(-2.5 - this.offset + slightOffset, 0, 15 - this.offset - slightOffset, Math.PI / 2, 5);
        this.enemyRoomGroup.add(this.enemyRoomWall4.mesh); 

        this.enemyRoomWall4 = new Wall(22.5 - this.offset + slightOffset, 0, 15 - this.offset - slightOffset, Math.PI / 2, 5);
        this.enemyRoomGroup.add(this.enemyRoomWall4.mesh); 
